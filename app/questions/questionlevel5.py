question5 =[
     {
       ...
       "instruction": ["Take numbers in single line input",
                        "Convert to list.",
                        "Write a function.",
 ...
 "test_case": [
    ...
    },
   {
      ...
      "instruction": ["Take sentence input.",
                       "Split into words.",
                       "Use dictionary.",
                       "Use loop.",
    ...
    },
    {
         ...
         "instruction": ["Take marks as input.",
    ...
    },
    {
         ...
         "instruction": ["Create dictionary to store contacts.",
                          "Use while True loop.",
                          "Show menu: Add, View, Delete, Exit",
                          "Use condition for choices.",
                          "Must maintain state.",
                          "Must not terminate until Exit selected."],
         "expects": {
             "requires_input": True,
    ...
    },
   {
           ...
           "instruction": ["Take multiple numbers in one line.",
                            "Convert into list.",
                            "Write function.",
                            "Use loop to sum.",
                            "Return total.",
                            "Must not use built-in sum()."],
           "expects": {
              "requires_input": True,
              "input_mode": "single_line",
              "requires_collection": True,
