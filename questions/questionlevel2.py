questions2= [
    {
        ...
        "instruction": ["Use input() to take one string value.",
                         "Store it in a variable named a.",
   ...
   },
   {
        ...
        "instruction": ["Take 10 integer inputs from user.",
                         "Store them in a list named num.",
...

   {
        ...
        "instruction": ["Take 5 integer inputs.",
     ...
     } ,
    {
        ...
        "instruction": ["Take 7 string inputs.",
