...
print(result)
'''✔ No split()
✔ Works with tokenized input
✔ Loop + condition + function + return'''

#✅ Q2: Word Frequency (ENGINE SAFE)
words = []
