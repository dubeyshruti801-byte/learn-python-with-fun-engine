...
questions_L2=[
   ...
   },
   {
        ...
        "expected_output":"Enter 1-10 numbers: \n num"
   },
   {
        "id" : 3,
        "prompt": "Take 1-10 even numbers from user , save it in variable 'even' and print it." ,
        "expected_output":"Enter 1-10 even numbers: \n even"
   },
   {
        "id" : 4,
        "prompt": "Take table of 2 from user (Without MULTIPLICATION), save it in variable 'table', and print it "
        "expected_output":"Enter table of 2 : \n table"
   },
   {
        "id" : 5,
        "prompt": "take days of week from user, save it in 'week'-Sunday Monday Tuesday Wednesday Thursday Friday Saturday" ,
        "expected_output":"Sunday Monday Tuesday Wednesday Thursday Friday Saturday"
   }
