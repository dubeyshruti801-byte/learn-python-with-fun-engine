question4=[
    {
      ...
      "instruction": ["Take 5 integers.",
                       "Store in a list.",
                       "Use for loop.",
                       "Use condition if num % 2 == 0.",
  ...
  },
  {
      ...
      "instruction": ["Take 5 student names and marks,Store them in dictionary.",
  ...
  },
  {
       ...
       "instruction": ["Take day, month, year as input.",
