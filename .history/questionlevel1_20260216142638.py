questions1=[
    {
          ...
          "instruction": ["Do NOT use input().",
                           "Simply print the exact word: shruti",
                           "You must use print().",
                           "Output must match exactly (case-sensitive).",
                           "Do not add extra spaces or symbols.",
                           "No variables required.",
                           "No loops, no conditions, no operations."],
          "expects": {
     ...
     },
   {
        ...
        "instruction": ["Do NOT use input().",
                         "Print a Python list containing: [Deepak, Priya, Dimple]",
                         "The output must be a list format (with square brackets and quotes).",
                         "Must use print().",
                         "No loops, no variables required.",
   ...
   },
   {
        ...
        "instructions": ["Do NOT use input().",
                         "Print a list exactly like: [Apple, Banana, Mango, Orange, Grapes]",
                         "Maintain correct spelling and case.",
                         "Use print().",
   ...
   },
   {
        ...
        "instructions": ["Do NOT use input().",
                         "Print all 12 months in a list.",
                         "Format must be:[January, ..., December],"
                         "Use print().",
