...
def validate_code(code, questions):
    ...
    def fake_input(prompt=""): nonlocal input_index # If only one input() is used (split-style question) if expects.get("min_value") and expects.get("requires_input"): if input_ind
